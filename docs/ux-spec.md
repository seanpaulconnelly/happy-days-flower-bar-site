...
| **Date**      | 2026-08-29                                                                                                                                                                                                                                                                                                      |
| **Sources**   | `website-spec.md` (approved copy + structure), `answers-from-bethany.md` (approved FAQ, event types, service area, socials), `claude-code-prompt.md`, `websites.md` (owner taste notes), `visual-reference.png` (direction, not a comp), the 9 supplied images, build plan §2 (R1–R12), §3.2, Phase 2a, Phase 5 |
...
| 8   | **FAQ** (new in V1, 8 approved Q&As)               | `#faq`          | Clear the last practical objections — lead time, travel, weather, what's included — immediately before the ask.                                                        | `answers-from-bethany.md` §3a; plan §1 "FAQ section is in V1" |
...
- Email link is `mailto:hello@happydaysflowers.com`; no phone, no street address, no hours (decided; `answers-from-bethany.md` §3c).
...
### 6.2 Type of Event — `<select>` options (verbatim from `answers-from-bethany.md` §2a, in her order)
...
| `success.body`                  | Confirmation body — **verbatim approved auto-reply** from `answers-from-bethany.md` §2b, with `{name}` substituted | Thanks, {name}! We received your inquiry and can’t wait to hear more about what you’re planning. We’ll be in touch within 2 business days to talk through your event and help you choose the right flower bar. |
...
| `about-bethany-working.jpeg`       | About                            | Glass cylinder vase of moss with tall blue delphinium, yellow craspedia, red carnations, pink spray roses and chamomile against a brick wall.                                  |
...
| 14  | Service area "approximately one hour or 50 miles from Greensburg"                                       | Footer and hero use the spec wording; the FAQ travel answer carries the 50-mile detail verbatim.                                                                                                                   | FAQ answer text matches `answers-from-bethany.md`.                                                  |
